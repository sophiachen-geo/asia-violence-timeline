...
export const CITATIONS = [
  ...
  { n: 10, text: "Yang Jisheng, Tombstone: The Great Chinese Famine, 1958 to 1962 (Farrar, Straus and Giroux, 2012).", url: "https://us.macmillan.com/books/9780374533861/tombstone" },
  { n: 11, text: "Frank Dik\u00f6tter, Mao's Great Famine (Walker and Company, 2010).", url: "https://www.bloomsbury.com/us/maos-great-famine-9781408827283" },
  { n: 12, text: "Frank Dik\u00f6tter, The Tragedy of Liberation (Bloomsbury, 2013).", url: "https://www.bloomsbury.com/us/the-tragedy-of-liberation-9781620403471" },
  { n: 13, text: "Judith Banister, China's Changing Population (Stanford University Press, 1987).", url: "https://www.sup.org/books/title/?id=2061" },
  ...
  { n: 15, text: "Roderick MacFarquhar and Michael Schoenhals, Mao's Last Revolution (Harvard, 2006).", url: "https://www.hup.harvard.edu/books/9780674027480" },
  { n: 16, text: "Daniel Goodkind and Loraine West, The North Korean Famine and Its Demographic Impact, Population and Development Review (2001).", url: "https://doi.org/10.1111/j.1728-4457.2001.00219.x" },
  { n: 17, text: "Andrei Lankov, Staying Alive, Foreign Affairs (March/April 2008).", url: "https://www.foreignaffairs.com" },
  { n: 18, text: "Ian Talbot and Gurharpal Singh, The Partition of India (Cambridge University Press, 2009).", url: "https://www.cambridge.org/9780521672566" },
  { n: 19, text: "Yang Kuisong, Reconsidering the Campaign to Suppress Counterrevolutionaries, The China Quarterly 193 (March 2008).", url: "https://doi.org/10.1017/S0305741008000076" },
  ...
  { n: 22, text: "CAVR Final Report, Chega! (Commission for Reception, Truth and Reconciliation in Timor-Leste, 2005).", url: "https://www.cavr-timorleste.org/en/chegaReport.htm" },
  { n: 23, text: "UN Panel of Experts on Accountability in Sri Lanka (March 2011).", url: "https://www.un.org/News/dh/infocus/Sri_Lanka/POE_Report_Full.pdf" },
  ...
  { n: 27, text: "Casualties of the Gaza War, Gaza Health Ministry and Israeli MFA (3 May 2026).", url: "https://www.ochaopt.org/" },
  ...
  { n: 43, text: "Maurice Meisner, Mao's China and After (Free Press, 1999); Philip Short, Mao: A Life (Henry Holt, 1999).", url: "https://www.simonandschuster.com/books/Maos-China-and-After/Maurice-Meisner/9780684856353" },
  { n: 44, text: "Sarmila Bose, Dead Reckoning (Hurst, 2011).", url: "https://www.hurstpublishers.com/book/dead-reckoning/" },
  ...
  { n: 50, text: "John W. Dower, Embracing Defeat: Japan in the Wake of World War II (W. W. Norton, 1999).", url: "https://wwnorton.com/books/9780393320275" },
  ...
  { n: 52, text: "Treaty of Mutual Cooperation and Security between the United States and Japan (signed January 19, 1960).", url: "https://www.mofa.go.jp/region/n-america/us/q&a/ref/1.html" },
  { n: 53, text: "Constitution of Japan, Article 9 (effective May 3, 1947).", url: "https://japan.kantei.go.jp/constitution_and_government_of_japan/constitution_e.html" },
...
export const COUNTRY_REGION = {
  ...
  // and no one-sided violence) so they classify correctly when
...
// Append a "+" suffix to a casualty / displaced figure when the event
// is still ongoing — but only if the string actually looks numeric and
// doesn't already declare itself open-ended. Strings like "minimal",
// "tens of thousands", "~75k+", or "~2k (ongoing)" pass through unchanged.
export function fmtFigure(value, ongoing) {
  if (!value || typeof value !== 'string') return value || '—';
  if (!ongoing) return value;
...
export const DATA_AS_OF = '12 May 2026';
...
export const EVENTS = [
  ...
  { name: "Fourth Taiwan Strait Crisis", countries: ["China", "Taiwan"], region: "East Asia", category: "Armed Conflict", start: 2022, end: 2022, deaths: "minimal", displaced: "minimal",
    ...
    cites: [] },
  { name: "Land Reform Campaign", countries: ["China"], region: "East Asia", category: "One-sided Violence", start: 1947, end: 1953, deaths: "1.5 to 2 M", displaced: "rural class structure dismantled",
    ...
    cites: [12] },
  { name: "Campaign to Suppress Counterrevolutionaries (Zhenfan)", countries: ["China"], region: "East Asia", category: "One-sided Violence", start: 1950, end: 1953, deaths: "712k to 2 M+", displaced: "1.29 M imprisoned",
    ...
    cites: [12, 19] },
  { name: "Anti Rightist Campaign", countries: ["China"], region: "East Asia", category: "One-sided Violence", start: 1957, end: 1959, deaths: "tens of thousands", displaced: "~550k to 2 M persecuted",
    ...
    cites: [12] },
  { name: "Great Leap Forward Famine", countries: ["China"], region: "East Asia", category: "One-sided Violence", start: 1958, end: 1962, deaths: "30 to 45 M", displaced: "massive internal",
    ...
    cites: [10, 11, 13] },
  { name: "Cultural Revolution", countries: ["China"], region: "East Asia", category: "One-sided Violence", start: 1966, end: 1976, deaths: "1.1 to 1.7 M", displaced: "17 M sent down",
    ...
    cites: [14, 15] },
  { name: "Tibetan Cultural Revolution Destruction", countries: ["China"], region: "East Asia", category: "One-sided Violence", start: 1966, end: 1976, deaths: "tens of thousands+", displaced: "cultural infrastructure razed",
    ...
    cites: [14] },
  { name: "Laogai Forced Labor System", countries: ["China"], region: "East Asia", category: "One-sided Violence", start: 1949, end: 2026, ongoing: true, excludedFromTotal: true, deaths: "large-scale detention and forced-labour system; cumulative mortality unknown and highly contested", displaced: "~50 M detained over system history (estimate; contested)",
    note: "The Chinese **laogai system** ('reform through labour') has operated continuously since 1949, processing political prisoners alongside ordinary criminals through an archipelago of camps. The Laogai Research Foundation has estimated cumulative detention at roughly fifty million, with deaths in the millions; both figures are contested and difficult to audit independently. The system absorbed surviving victims of the Anti-Rightist Campaign and the Cultural Revolution, formed the institutional precedent for the laojiao 're-education through labour' system that was formally abolished in 2013, and provides part of the operational template for the **Xinjiang internment infrastructure** built since 2017. Forced-labour extraction continues in modified form in Xinjiang, Tibet, and certain provincial production chains, and remains a point of contention in international trade policy. Because no defensible mid-range mortality estimate is available, this event is excluded from cumulative death totals.",
    cites: [] },
  { name: "Tiananmen Square Massacre", countries: ["China"], region: "East Asia", category: "One-sided Violence", start: 1989, end: 1989, deaths: "hundreds to ~10k contested", displaced: "minimal",
    ...
    cites: [6, 7] },
  { name: "Falun Gong Persecution", countries: ["China"], region: "East Asia", category: "One-sided Violence", start: 1999, end: 2026, ongoing: true, excludedFromTotal: true, deaths: "thousands of deaths in custody documented; far higher mortality alleged but contested", displaced: "millions detained cumulatively (contested)",
    note: "Jiang Zemin banned the spiritual movement on **20 July 1999** after the April 1999 Zhongnanhai sit-in, and Vice-Premier Li Lanqing announced thirty-five thousand detentions in the following four months. Two distinct evidentiary tracks should be distinguished. First, practitioner-compiled documentation (the Minghui database) lists thousands of named deaths in custody; the documenting organisations themselves note these figures are practitioner-compiled and significantly undercounted because of censorship inside China, and they have not been independently audited. Second, the **Independent Tribunal into Forced Organ Harvesting** (the China Tribunal) chaired by Sir Geoffrey Nice KC delivered its Final Judgment on 17 June 2019 finding that forced organ harvesting from prisoners of conscience had been practiced for a substantial period, with Falun Gong practitioners constituting the main source; the Tribunal's findings remain politically and evidentially contested and should not be treated as a demographic mortality study. Robertson and Lavee's peer-reviewed analysis in the *American Journal of Transplantation* in 2022 separately found organ procurement causing death in violation of the dead donor rule. Because no defensible mid-range mortality estimate is available, this event is excluded from cumulative death totals.",
    cites: [35] },
  { name: "Xinjiang Internment and Cultural Repression", countries: ["China"], region: "East Asia", category: "One-sided Violence", start: 2014, end: 2026, ongoing: true, excludedFromTotal: true, deaths: "uncounted; deaths in custody (no defensible mid-range estimate)", displaced: "1 to 1.8 M detained",
    note: "Following the May 2014 Ürümqi attack and Xi Jinping's announcement of the **Strike Hard Campaign**, mass internment infrastructure was rapidly built from 2017, with **Adrian Zenz's** revised November 2019 estimate placing detention at up to 1.8 million Uyghurs and other Turkic Muslims across approximately 1,300 to 1,400 facilities, a figure separately corroborated by the Chinese Human Rights Defenders network. The **UN Human Rights Office's August 2022 assessment** under Michelle Bachelet found that the conduct may constitute international crimes, in particular crimes against humanity, but did not apply the genocide label. The **legislatures of the United States, the United Kingdom, Canada, and the Netherlands** have separately designated the campaign as genocide. Outside the camps, forced sterilisation, family separation through transnational repression and intra-Chinese labour transfers, and pervasive surveillance affect roughly eleven million Uyghurs. The Xinjiang Police Files leak of 2022 added photographs and dossiers of approximately five thousand detainees to the public evidentiary record. Because no defensible mid-range mortality estimate is available, this event is excluded from cumulative death totals.",
    cites: [8, 20] },
  { name: "Kwalliso Political Prison Camp System", countries: ["North Korea"], region: "East Asia", category: "One-sided Violence", start: 1947, end: 2026, ongoing: true, excludedFromTotal: true, deaths: "cumulative mortality unknown; UN COI describes \"hundreds of thousands\" but figure is not auditable", displaced: "80k to 120k at any time",
    ...
    cites: [36] },
  { name: "North Korean Famine (Arduous March)", countries: ["North Korea"], region: "East Asia", category: "One-sided Violence", start: 1994, end: 1998, deaths: "600k to 1 M", displaced: "internal economic dislocation",
    ...
    cites: [16, 17] },
  { name: "Jeju 4.3 Uprising and Massacre", countries: ["South Korea"], region: "East Asia", category: "One-sided Violence", start: 1948, end: 1954, deaths: "14k to 30k", displaced: "230+ villages destroyed",
    ...
    cites: [] },
  { name: "Bodo League Massacre", countries: ["South Korea"], region: "East Asia", category: "One-sided Violence", start: 1950, end: 1950, deaths: "100k to 200k", displaced: "minimal",
    ...
    cites: [] },
  { name: "Gwangju Uprising and Massacre", countries: ["South Korea"], region: "East Asia", category: "One-sided Violence", start: 1980, end: 1980, deaths: "200 to 2k", displaced: "minimal",
    ...
    cites: [] },
  { name: "Taiwan White Terror (228 Incident and Martial Law)", countries: ["Taiwan"], region: "East Asia", category: "One-sided Violence", start: 1947, end: 1987, deaths: "~18k to 28k (228) + 140k imprisoned", displaced: "~3k to 4k executed",
  ...
  { name: "Vietnam War (Second Indochina)", countries: ["Vietnam"], region: "Southeast Asia", category: "Armed Conflict", start: 1955, end: 1975, deaths: "~3 M", displaced: "~3 M",
    ...
    cites: [1, 2] },
  { name: "Brunei Revolt", countries: ["Brunei"], region: "Southeast Asia", category: "Armed Conflict", start: 1962, end: 1962, deaths: "~50 to 100", displaced: "minimal",
    note: "An uprising by the **TNKU (Tentera Nasional Kalimantan Utara, the North Kalimantan National Army)** beginning **8 December 1962** opposed the Brunei sultanate's accession to the proposed Federation of Malaysia. British and Gurkha forces deployed from Singapore suppressed the revolt within a fortnight. The UK House of Commons recorded British and Gurkha service casualties alongside police and civilian deaths; estimates of rebel fatalities are in the fifty-to-sixty range with total deaths in the low hundreds. The revolt contributed to Brunei's eventual decision **not to join the Federation of Malaysia** in 1963 and helped set the conditions for the **Indonesia–Malaysia Confrontation (Konfrontasi)** that followed.",
    cites: [] },
  { name: "West Papua Conflict", countries: ["Indonesia"], region: "Southeast Asia", category: "Armed Conflict", start: 1963, end: 2026, ongoing: true, deaths: "100k+", displaced: "~80k",
  ...
  { name: "Myanmar Rohingya Crisis", countries: ["Myanmar"], region: "Southeast Asia", category: "Armed Conflict", start: 2016, end: 2017, deaths: "25k+", displaced: "~900k",
    ...
    cites: [4, 21] },
  { name: "Myanmar Post Coup Civil War", countries: ["Myanmar"], region: "Southeast Asia", category: "Armed Conflict", start: 2021, end: 2026, ongoing: true, deaths: "~90k", displaced: "~3.5 M",
    ...
    cites: [4, 31] },
  { name: "Thailand–Cambodia Border Clashes, 2025–2026", countries: ["Thailand", "Cambodia"], region: "Southeast Asia", category: "Armed Conflict", start: 2025, end: 2026, deaths: "149+", displaced: "~750k",
    ...
    cites: [32] },
  { name: "Vietnamese Reeducation Camps", countries: ["Vietnam"], region: "Southeast Asia", category: "One-sided Violence", start: 1975, end: 1992, deaths: "~50k to 150k", displaced: "500k to 1 M detained",
    ...
    cites: [] },
  { name: "New Economic Zones Program", countries: ["Vietnam"], region: "Southeast Asia", category: "One-sided Violence", start: 1975, end: 1985, deaths: "tens of thousands (incl. boat people)", displaced: "~1 M relocated",
    ...
    cites: [] },
  { name: "Laotian Reeducation and Hmong Persecution", countries: ["Laos"], region: "Southeast Asia", category: "One-sided Violence", start: 1975, end: 2026, deaths: "tens of thousands cumulative", displaced: "~300k Hmong refugees",
    ...
    cites: [] },
  { name: "Burmese Junta Political Repression", countries: ["Myanmar"], region: "Southeast Asia", category: "One-sided Violence", start: 1962, end: 2026, deaths: "13k+ documented", displaced: "tens of thousands detained",
  ...
  { name: "Balochistan Insurgency", countries: ["Pakistan"], region: "South Asia", category: "Armed Conflict", start: 2004, end: 2026, deaths: "~15k", displaced: "~100k",
    ...
    cites: [3] },
  { name: "Afghanistan–Pakistan Border Clashes and Cross-Border Militant Violence", countries: ["Afghanistan", "Pakistan"], region: "South Asia", category: "Armed Conflict", start: 2024, end: 2026, ongoing: true, deaths: "ongoing, hundreds+", displaced: "~115k",
  ...
  { name: "2025 India Pakistan War (Operation Sindoor)", countries: ["India", "Pakistan"], region: "South Asia", category: "Armed Conflict", start: 2025, end: 2025, deaths: "~70+", displaced: "~300k",
    ...
    cites: [] },
  { name: "Partition of India Massacres", countries: ["India", "Pakistan"], region: "South Asia", category: "One-sided Violence", start: 1946, end: 1948, deaths: "1 to 2 M", displaced: "14 to 18 M",
    ...
    cites: [18] },
  { name: "Sri Lankan JVP First Insurrection Suppression", countries: ["Sri Lanka"], region: "South Asia", category: "One-sided Violence", start: 1971, end: 1971, deaths: "~4k to 5k", displaced: "~20k arrested",
    ...
    cites: [] },
  { name: "1984 Anti Sikh Pogrom", countries: ["India"], region: "South Asia", category: "One-sided Violence", start: 1984, end: 1984, deaths: "3k to 17k", displaced: "~50k",
    ...
    cites: [6] },
  { name: "Sri Lankan JVP Second Insurrection and Politicide", countries: ["Sri Lanka"], region: "South Asia", category: "One-sided Violence", start: 1987, end: 1990, deaths: "~30k to 60k", displaced: "60k+ disappeared",
    ...
    cites: [] },
  { name: "2002 Gujarat Anti Muslim Pogrom", countries: ["India"], region: "South Asia", category: "One-sided Violence", start: 2002, end: 2002, deaths: "1k to 2k+", displaced: "~150k",
    ...
    cites: [6] },
  { name: "Sri Lankan Civil War Final Phase (Mullivaikkal)", countries: ["Sri Lanka"], region: "South Asia", category: "One-sided Violence", start: 2009, end: 2009, deaths: "40k to 70k+", displaced: "~290k detained",
  ...
  { name: "Kyrgyz Tajik Border Conflict", countries: ["Kyrgyzstan", "Tajikistan"], region: "Central Asia", category: "Armed Conflict", start: 2021, end: 2022, deaths: "~150+", displaced: "~50k briefly",
    ...
    cites: [3] },
  { name: "Andijan Massacre", countries: ["Uzbekistan"], region: "Central Asia", category: "One-sided Violence", start: 2005, end: 2005, deaths: "~500 to 1,500 contested", displaced: "thousands fled",
  ...
  { name: "2023 Karabakh Offensive", countries: ["Azerbaijan", "Armenia"], region: "West Asia", category: "Armed Conflict", start: 2023, end: 2023, deaths: "~700 combined", displaced: "~100k Armenians",
    ...
    cites: [] },
  { name: "Israel Hamas Gaza War", countries: ["Israel", "Palestine"], region: "West Asia", category: "Armed Conflict", start: 2023, end: 2025, ongoing: true, deaths: "~75k+", displaced: "~1.9 M",
  ...
  { name: "2025 Israel Iran War (Twelve Day War)", countries: ["Israel", "Iran"], region: "West Asia", category: "Armed Conflict", start: 2025, end: 2025, deaths: "~1.2k", displaced: "minimal",
    ...
    cites: [28, 29] },
  { name: "Iran–Israel/US Hostilities, 2026", countries: ["Israel", "Iran"], region: "West Asia", category: "Armed Conflict", start: 2026, end: 2026, ongoing: true, deaths: "~2k (ongoing)", displaced: "tens of thousands",
    ...
    cites: [28] },
  { name: "Israel–Hezbollah/Lebanon Hostilities, 2026", countries: ["Israel", "Lebanon"], region: "West Asia", category: "Armed Conflict", start: 2026, end: 2026, ongoing: true, deaths: "~2.6k+ (ongoing)", displaced: "~1 M",
    ...
    cites: [33] },
  { name: "Iraqi Anti Communist and Ba'athist Purges", countries: ["Iraq"], region: "West Asia", category: "One-sided Violence", start: 1963, end: 1979, deaths: "~3k to 5k+", displaced: "minimal",
    ...
    cites: [] },
  { name: "Hama Massacre", countries: ["Syria"], region: "West Asia", category: "One-sided Violence", start: 1982, end: 1982, deaths: "10k to 40k", displaced: "minimal",
    ...
    cites: [7, 25] },
  { name: "Anfal Genocide", countries: ["Iraq"], region: "West Asia", category: "One-sided Violence", start: 1986, end: 1989, deaths: "50k to 180k", displaced: "thousands of villages destroyed",
    ...
    cites: [6] },
  { name: "1988 Iranian Executions of Political Prisoners", countries: ["Iran"], region: "West Asia", category: "One-sided Violence", start: 1988, end: 1988, deaths: "~2.8k to 30k", displaced: "minimal",
    ...
    cites: [7, 40] },
  { name: "Iraqi Marsh Arab Persecution", countries: ["Iraq"], region: "West Asia", category: "One-sided Violence", start: 1991, end: 2003, deaths: "tens of thousands", displaced: "~200k forcibly displaced",
    ...
    cites: [6, 8] },
  { name: "Yazidi Genocide by ISIS", countries: ["Iraq"], region: "West Asia", category: "One-sided Violence", start: 2014, end: 2015, deaths: "~5k killed; 7k enslaved", displaced: "~400k",
    ...
    cites: [37] },
  { name: "Sednaya Prison and Assad Regime Detention", countries: ["Syria"], region: "West Asia", category: "One-sided Violence", start: 2011, end: 2024, deaths: "~30k+ in Sednaya alone", displaced: "subsumed in Syrian Civil War",
    ...
    cites: [7, 25] },
  { name: "2025 Syrian Coastal Massacres", countries: ["Syria"], region: "West Asia", category: "One-sided Violence", start: 2025, end: 2025, deaths: "~1.4k to 1.7k Alawites", displaced: "thousands fled coast",
...
function IntroSection({ eyebrow, children, id }) {
  return (
...
// ============================================================
// METHODOLOGY DATASET EXPORT
//
// Produces a CSV row per catalogue event with the auditable fields
// described in the methodology section. Coded fields (fatality_type,
// legal_terms_used, etc.) are derived heuristically from the event's
// own text and category; they're meant to support reviewer audit, not
// to stand alone as authoritative coding judgments.
// ============================================================

function parseRange(s) {
  if (!s || typeof s !== 'string') return { low: '', mid: '', high: '' };
  let txt = s.toLowerCase().replace(/[~+,]/g, ' ').trim();
  if (/^minimal\b/.test(txt) || /subsumed/.test(txt)) return { low: 0, mid: 0, high: 0 };
  if (!/\d/.test(txt)) {
    const v = parseEstimate(s);
    return v > 0 ? { low: Math.round(v * 0.5), mid: v, high: Math.round(v * 1.5) } : { low: '', mid: '', high: '' };
  }
  const mult = (c) => c === 'k' ? 1000 : c === 'm' ? 1000000 : c === 'b' ? 1000000000 : 1;
  const rangeRe = /(\d+(?:\.\d+)?)\s*([kmb])?\s*(?:to|-|–|—)\s*(\d+(?:\.\d+)?)\s*([kmb])?/i;
  const m = txt.match(rangeRe);
  if (m) {
    ...
    const hiSuffix = (m[4] || '').toLowerCase();
    const effectiveLo = loSuffix || (hiSuffix && lo < 100 ? hiSuffix : '');
    const low = lo * mult(effectiveLo);
    const high = hi * mult(hiSuffix);
    return { low, mid: (low + high) / 2, high };
  }
  const singleRe = /(\d+(?:\.\d+)?)\s*([kmb])?/i;
  const sm = txt.match(singleRe);
  if (sm) {
    const v = parseFloat(sm[1]) * mult((sm[2] || '').toLowerCase());
    return { low: v, mid: v, high: v };
  }
  return { low: '', mid: '', high: '' };
}

function classifyFatalityType(ev) {
  const t = (ev.name + ' ' + (ev.note || '') + ' ' + (ev.deaths || '')).toLowerCase();
  if (/famine|great leap|arduous march/.test(t)) return 'policy-induced famine mortality';
  if (/laogai|kwalliso|reeducation|reeducation camp|prison camp|detention|kyo-hwa-so|laojiao/.test(t)) return 'detention mortality';
  if (/excess mortality|demographic/.test(t)) return 'excess mortality';
  if (/massacre|pogrom|genocide|ethnic cleansing|politicide|killings/.test(t)) return 'one-sided / civilian deaths';
  if (ev.category === 'Armed Conflict') return 'mixed (battle deaths + civilian)';
  return 'one-sided / civilian deaths';
}

function classifyDisplacementType(ev) {
  const t = (ev.displaced || '').toLowerCase();
  if (!t || /minimal/.test(t)) return '';
  if (/detained|imprisoned|interned/.test(t)) return 'detention';
  if (/refugee/.test(t)) return 'refugee flow';
  if (/internal|displaced/.test(t)) return 'internal displacement';
  return 'displacement (type unspecified)';
}

const LEGAL_TERMS = [
  'genocide', 'crimes against humanity', 'ethnic cleansing',
  'occupation', 'war crimes', 'politicide', 'apartheid',
];

function extractLegalTerms(ev) {
  const t = (ev.note || '').toLowerCase();
  const found = LEGAL_TERMS.filter(k => t.includes(k));
  return found.join('; ');
}

const LEGAL_SOURCES = [
  'UN Independent Fact-Finding Mission', 'UN Commission of Inquiry',
  'UN Panel of Experts', 'OHCHR', 'ICJ', 'International Court of Justice',
  'ICC', 'International Criminal Court', 'Human Rights Watch',
  'Amnesty International', 'Permanent Peoples', 'Tribunal',
  'United States', 'United Kingdom', 'Canadian House of Commons',
  'Dutch Parliament', 'European Parliament',
];

function extractLegalTermSources(ev) {
  if (!extractLegalTerms(ev)) return '';
  const t = ev.note || '';
  const found = LEGAL_SOURCES.filter(s => t.includes(s));
  return found.join('; ');
}

function extractUncertainty(ev) {
  const flags = [];
  if (ev.excludedFromTotal) flags.push('excluded from cumulative totals (mortality not auditable)');
  const t = ((ev.deaths || '') + ' ' + (ev.displaced || '')).toLowerCase();
  if (/contested/.test(t)) flags.push('figures contested');
  if (/uncounted/.test(t)) flags.push('mortality uncounted');
  if (/cumulative/.test(t)) flags.push('cumulative figure spans multi-decade system');
  if (ev.ongoing) flags.push('ongoing event; figures running');
  return flags.join('; ');
}
...
export function buildMethodologyCsv() {
  const headers = [
    'event_id', 'event_name', 'country_displayed', 'countries_involved',
    'region', 'start_year', 'end_year', 'ongoing_flag',
    'category', 'category_is_custom_extension',
    'included_in_death_total', 'included_in_displacement_total',
    'fatalities_text', 'fatalities_low', 'fatalities_mid', 'fatalities_high', 'fatality_type',
    'displacement_text', 'displacement_low', 'displacement_mid', 'displacement_high', 'displacement_type',
    'cites', 'legal_terms_used', 'legal_term_source',
    'notes_on_uncertainty', 'last_updated',
  ];

  const lines = [headers.map(csvEscape).join(',')];

  for (const e of EVENTS) {
    const dRange = parseRange(e.deaths);
    const xRange = parseRange(e.displaced);
    const row = [
      slugify(e.name),
      e.name,
      e.countries[0] || '',
      ...
      e.category,
      e.category === 'One-sided Violence' ? 'true' : 'false',
      e.excludedFromTotal ? 'no' : 'yes',
      e.excludedFromTotal ? 'no' : 'yes',
      e.deaths || '',
      dRange.low, dRange.mid, dRange.high,
      classifyFatalityType(e),
      e.displaced || '',
      xRange.low, xRange.mid, xRange.high,
      classifyDisplacementType(e),
      (e.cites || []).join(';'),
      extractLegalTerms(e),
      extractLegalTermSources(e),
      extractUncertainty(e),
      DATA_AS_OF,
    ];
...
export function downloadMethodologyCsv() {
  const csv = buildMethodologyCsv();
  const blob = new Blob([csv], { type: 'text/csv;charset=utf-8;' });
  const url = URL.createObjectURL(blob);
  const a = document.createElement('a');
  a.href = url;
  a.download = `asia-violence-catalogue-${DATA_AS_OF.replace(/\s+/g, '-')}.csv`;
...
function EventRow({ ev, expanded, onToggle, yearStart, yearEnd, dense }) {
  ...
  const isPV = ev.category === "One-sided Violence";
  // Hover tooltip on the bar carries the year span and the countries
  // involved, so the per-row date sub-label can be removed from under
  // the name. The native title attribute is enough; no custom popover.
  const hoverLabel = yearLabel + ' · ' + ev.countries.join(' · ');

  return (
    <div className="group">
      <button onClick={onToggle} className="w-full text-left flex items-stretch gap-3"
        style={{
          borderTop: '1px solid rgba(var(--text-rgb),0.06)',
          paddingTop: dense ? 3 : 8,
        ...
        <div className="relative flex-1" style={{ minHeight: dense ? 16 : 28 }} title={hoverLabel}>
      ...
      {expanded && (
        <div className="pl-3 pr-2 pb-4 pt-2 text-[12.5px] leading-relaxed" style={{
          ...
          <div className="mono text-[10px] mb-3 flex flex-wrap gap-x-3 gap-y-1" style={{ color: 'rgba(var(--text-rgb),0.6)' }}>
            ...
            <span>DEAD {fmtFigure(ev.deaths, ev.ongoing)}</span>
            <span>DISPLACED {fmtFigure(ev.displaced, ev.ongoing)}</span>
          </div>
          <div className="sans">
            {renderBold(ev.note)}
...
// Countries that appear with no qualifying catalogue entry under the
// project's current inclusion rules. This is NOT a list of "peaceful
// societies" or proof of an absence of state violence. It means only
// that no event meeting the catalogue's inclusion threshold has been
// entered after the stated exclusions and caveats are applied.
//
// Brunei was previously listed here; it has since been removed because
// the 1962 Brunei Revolt meets this project's armed-conflict threshold
// and is included as a catalogue entry.
//
// Kazakhstan is treated as an edge case: the January 2022 unrest and
// crackdown involved mass casualties and credible allegations of
// excessive state force. Classification under UCDP-style one-sided
// violence requires careful treatment, so Kazakhstan is shown here
// with an explicit edge-case marker.
//
// Singapore is treated only as a post-independence case. The 1964
// communal riots and 1965 MacDonald House bombing belong to the
// island's immediate pre-independence history and are not used to
// disqualify the post-1965 record.
const EXCEPTIONS = [
  {
    country: "Japan", region: "East Asia", population: "~125 M",
    archetype: "Constitutional alliance",
    rationale: "No qualifying post-1945 internal armed-conflict or one-sided violence catalogue entry. Constitutional renunciation of war plus external security treaty.",
    note: "Postwar Japan developed under extensive American military protection despite constitutional restrictions on warfare. The arrangement was unusual when it was made and remains unusual now.",
  },
  {
    country: "Mongolia", region: "East Asia", population: "~3 M",
    archetype: "Geographic buffer",
    rationale: "No qualifying post-1945 catalogue entry. Position between major powers with alignment to the regional security provider.",
    note: "Mongolia remained deeply constrained by Soviet influence throughout much of the Cold War, and has since pursued a balanced posture between its two large neighbours.",
  },
  {
    country: "Singapore", region: "Southeast Asia", population: "~5.5 M",
    archetype: "Small sheltered economy",
    rationale: "Post-independence (1965 onward) only. 1964 communal riots and 1965 MacDonald House bombing pre-date independence and sit outside this catalogue’s rules.",
    note: "Singapore combined stability with highly securitized governance and extensive restrictions on opposition politics. The early years of Singapore's modern statehood were not, in fact, free of organized violence. The communal riots of July and September 1964 produced approximately thirty-six deaths and more than five hundred injuries on the island. The Indonesia–Malaysia Confrontation (Konfrontasi, 1963 to 1966) brought direct attacks on Singapore, including the MacDonald House bombing of March 10, 1965, which killed three civilians and wounded thirty-three. What the catalogue records is the period after independence in August 1965, during which the post-separation Singaporean state has, under this project's inclusion rules, experienced no qualifying internal armed conflict or one-sided violence catalogue entry. The earlier turbulence is part of the same history as the later stability; the stability did not erase what came before it, and an honest framing of Singapore here requires this qualification.",
  },
  {
    country: "Kazakhstan", region: "Central Asia", population: "~20 M",
    archetype: "Geographic buffer",
    rationale: "Edge case. No qualifying catalogue entry under current rules, but the January 2022 unrest sits close to the inclusion threshold.",
    edgeCase: true,
    note: "Kazakhstan is treated as an edge case because the January 2022 unrest and crackdown involved mass casualties and credible allegations of excessive state force, even though classification under UCDP-style one-sided violence requires careful treatment. A further caveat applies across this archetype: authoritarian opacity in Kazakhstan and Turkmenistan means their inclusion among the exceptions depends on the absence of documented mass violence rather than on the proven absence of mass violence.",
  },
  {
    country: "Turkmenistan", region: "Central Asia", population: "~6 M",
    archetype: "Geographic buffer",
    rationale: "No qualifying post-1945 catalogue entry. Geographic buffer position combined with extensive state opacity.",
    note: "Inclusion depends on the absence of documented mass violence rather than on the proven absence of mass violence. The classification is the most defensible one available, but it is a classification under epistemic constraint, and readers are asked to keep this in view.",
  },
];
...
const ARCHETYPES = [
  {
    ...
    countries: ["Japan"],
    body: "Japan is the only case in this archetype. Article 9 of the 1947 Constitution constitutes the explicit renunciation of war as a sovereign right; the 1960 Treaty of Mutual Cooperation and Security between the United States and Japan constitutes the implicit subcontract through which the defense function was delegated. The combination was unusual then, and it remains unusual now. Every other Asian state with comparable industrial weight retained military projection as a sovereign function. Japan delegated it. John Dower's *Embracing Defeat* traces the immediate postwar conditions under which the delegation was institutionalized — the dense interweaving of American occupation policy with Japanese reform politics, and the way in which a defeated, devastated society negotiated the terms of its own reconstruction under foreign supervision. Chalmers Johnson's *MITI and the Japanese Miracle* documents the developmental architecture that grew within the security shadow this arrangement provided, and the way that architecture produced the postwar Japanese economy in something close to its present form. The resulting peace was real. It was not, in any straightforward sense, a peace of Japan's own unilateral making.",
    cites: [50, 51, 52, 53],
  },
  {
    ...
    body: "Mongolia, Kazakhstan, and Turkmenistan occupy this archetype. Each sits between major powers whose direct confrontation across the territory would not, on calculation, be resolved by absorbing the buffer state, and each pairs that geographic position with alignment to the regional security provider. Mongolia held a Soviet-aligned posture through 1990 and a balanced one since, on the long arc that Morris Rossabi traces from khans through commissars to capitalists. Kazakhstan and Turkmenistan emerged from the Soviet dissolution into a regional system in which Russia retained the principal security role and the new states retained the option of close economic ties to China and the West simultaneously. The buffer logic has held, so far, in all three cases. A qualification is required: authoritarian opacity in Kazakhstan and Turkmenistan means their inclusion among the exceptions depends on the absence of documented mass violence rather than on the proven absence of mass violence. The classification is the most defensible one available, but it is a classification under epistemic constraint, and readers are asked to keep this in view.",
    cites: [49],
  },
  {
    ...
    countries: ["Singapore"],
    body: "Singapore and Brunei share this archetype; only Singapore remains in this category once the 1962 Brunei Revolt is included as a catalogue entry. Both are small enough that their absorption into a major-power calculation would yield little relative to its cost. Both maintain functional security relationships — Singapore through ASEAN, an active citizen army, and the Five Power Defence Arrangements with the United Kingdom, Australia, New Zealand, and Malaysia; Brunei through residual British arrangements that survived its 1984 independence. Both run economies whose returns from trade integration substantially exceed any plausible returns from territorial assertion. Meredith Weiss's *The Roots of Resilience*, published by Cornell University Press in 2020, frames Singapore — together with Malaysia — as an electoral-authoritarian hybrid regime in which authoritarian acculturation, patronage, and the depth of party-state grassroots machines sustain regime durability across successive cycles of contestation. Brunei's smallness and the longevity of its dynastic-monarchical arrangements have, in their own way, produced an equivalent insulation.",
    cites: [48],
  },
];
  ...
  return (
    <div className="my-6 border-y py-4" style={{ borderColor: 'rgba(var(--text-rgb),0.12)' }}>
      <div className="mono text-[10px] tracking-[0.1em] mb-4" style={{ color: 'rgba(var(--text-rgb),0.55)' }}>
        COUNTRIES WITH NO CURRENT CATALOGUE ENTRY UNDER THESE RULES · CLICK A COUNTRY TO READ
      </div>
      <div className="space-y-2">
        {EXCEPTIONS.map(row => {
          ...
          return (
            <div key={row.country}
              style={{
                ...
                borderRadius: 10,
                background: isOpen ? 'rgba(var(--text-rgb),0.03)' : 'transparent',
              ...
              <button
                ...
                style={{
                  ...
                  padding: '14px 18px',
                  display: 'grid',
                  gridTemplateColumns: 'minmax(140px, 1.4fr) minmax(80px, 0.7fr) minmax(140px, 1fr) minmax(220px, 2.4fr) 24px',
                  gap: 18, alignItems: 'baseline',
                }}>
                <div>
                  <div className="mono text-[9px] tracking-[0.18em] mb-1" style={{ color: 'rgba(var(--text-rgb),0.5)' }}>
                    <span className="inline-block w-1.5 h-1.5 rounded-full mr-2 align-middle" style={{ backgroundColor: r.color }} />
                    {row.region.toUpperCase()}
                  </div>
                  <div className="serif" style={{ color: 'var(--text)', fontSize: 18, lineHeight: 1.1 }}>
                    {row.country}
                    {row.edgeCase && (
                      <span className="mono ml-2 text-[9px] tracking-wider align-middle"
                ...
                <div>
                  ...
                  <div className="sans text-[13px]" style={{ color: 'var(--text)' }}>
                    {row.population}
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="sans text-[12.5px] leading-relaxed" style={{ color: 'rgba(var(--text-rgb),0.78)' }}>
                    {row.rationale}
                  </div>
                </div>
                <span className="mono text-[14px] self-center" style={{ color: 'rgba(var(--text-rgb),0.5)' }} aria-hidden>
                  {isOpen ? '−' : '+'}
                </span>
              </button>
              {isOpen && row.note && (
                <div style={{
                  ...
                  <p className="sans text-[13.5px] leading-relaxed pt-3"
                    style={{ color: 'rgba(var(--text-rgb),0.85)' }}>
                    {row.note}
                  </p>
                </div>
...
function ArchetypesDiagram() {
  ...
  // Render markdown-style *italics* in archetype body text without a
  // full markdown dependency. Returns an array of text and <em> nodes.
  const renderItalics = (s) => s.split(/(\*[^*]+\*)/g).map((seg, i) => {
  ...
  return (
    <div className="my-6">
      <div className="mono text-[10px] tracking-[0.1em] mb-4" style={{ color: 'rgba(var(--text-rgb),0.55)' }}>
        THREE PATHS TO PEACE · ONE ARCHETYPE PER COUNTRY · CLICK A CARD TO READ THE MECHANISM
      </div>
          ...
          return (
            <div key={a.name}
              style={{
                ...
                borderRadius: 14,
                backgroundColor: isOpen ? accent + '14' : 'rgba(var(--text-rgb),0.015)',
              ...
              <button
                ...
                <h4 className="serif font-medium"
                  style={{ color: 'var(--text)', fontSize: '20px', lineHeight: 1.15 }}>
                  {a.name}
                </h4>
                <div className="w-12 h-px" style={{ backgroundColor: accent, opacity: 0.5 }} />
                <div>
                  <div className="mono text-[9px] tracking-[0.18em] mb-1" style={{ color: 'rgba(var(--text-rgb),0.5)' }}>
                    MECHANISM
                  </div>
                  <div className="sans text-[12.5px] leading-relaxed" style={{ color: 'rgba(var(--text-rgb),0.82)' }}>
                    {a.mechanism}
                  </div>
                </div>
                <div>
                  ...
                  <ul className="serif text-[15px]" style={{ color: 'var(--text)' }}>
                    {a.countries.map(c => <li key={c}>{c}</li>)}
                  </ul>
                </div>
                <span className="mono text-[9px] tracking-[0.2em] mt-1"
                  style={{ color: accent, opacity: isOpen ? 0 : 0.7 }}>
                  CLICK TO READ ▾
                </span>
              </button>
              {isOpen && (
                <div style={{
                  ...
                  <p className="sans text-[13.5px] leading-relaxed pt-3"
                    style={{ color: 'rgba(var(--text-rgb),0.88)' }}>
                    {renderItalics(a.body)}
                  </p>
...
// Three historical mechanisms used by Part III: each renders as a
// row in MechanismsTwoColumn — left = small label card, right = the
// full body prose. Body text contains <Cite> nodes and <em> markup,
// so each `body` is a JSX fragment (not a plain string).
const MECHANISMS = [
  {
    n: 1,
    label: "MECHANISM 1 · 1850 to 1945",
    color: "#c69449",
    title: "Imperial labor extraction",
    summary: "Railways, Gold Rush, plantations, annexation, indenture.",
    body: (
      <>
        <p>
  ...
  {
    n: 2,
    label: "MECHANISM 2 · 1945 to present",
    color: "#c4615d",
    title: "Violent decolonization",
    summary: "Partition, Indochina, Korea, Vietnam, Palestine, Iraq.",
    body: (
      <>
        <p>
  ...
  {
    n: 3,
    label: "MECHANISM 3 · 1965 to present",
    color: "#5a8a85",
    title: "Refugee production and immigration reform",
    summary: "US Hart-Celler 1965; Canada points system 1967; the diasporas that followed.",
    body: (
      <>
        <p>
...
function MechanismsTwoColumn({ mechanisms }) {
  return (
    <div className="my-8 space-y-6">
      <div className="mono text-[10px] tracking-[0.1em]" style={{ color: 'rgba(var(--text-rgb),0.55)' }}>
        THREE MECHANISMS · LABOR EXTRACTION TO DISPLACEMENT TO ARRIVAL
      </div>
      {mechanisms.map(m => (
        <article key={m.n} className="grid gap-4 sm:gap-6 md:gap-8"
          style={{ gridTemplateColumns: 'minmax(220px, 1fr) minmax(0, 2.6fr)' }}>
          {/* LEFT: small mechanism card */}
          <aside className="rounded-2xl p-4 sm:p-5 self-start"
            style={{
              border: '1px solid ' + m.color,
              background: m.color + '12',
            }}>
            <div className="mono text-[10px] tracking-[0.1em] mb-2"
              style={{ color: m.color }}>
              {m.label}
            </div>
            <h3 className="serif font-medium"
              style={{ color: 'var(--text)', fontSize: '20px', lineHeight: 1.15, marginBottom: 10 }}>
              {m.title}
            </h3>
            <div className="w-10 h-px mb-3" style={{ background: m.color, opacity: 0.6 }} />
            <p className="sans text-[12.5px] leading-relaxed"
              style={{ color: 'rgba(var(--text-rgb),0.78)' }}>
              {m.summary}
            </p>
          </aside>
          {/* RIGHT: full body text */}
          <div className="space-y-4 sans text-[14px] sm:text-[15px] leading-relaxed"
            style={{ color: 'rgba(var(--text-rgb),0.88)' }}>
            {m.body}
          </div>
        </article>
...
function TopNav({ theme, setTheme }) {
  // Sticky nav with About dropdown + Part anchors + References. The
  // dropdown closes on item-click, on outside-click, and on Escape.
  const [openAbout, setOpenAbout] = useState(false);
  const aboutRef = useRef(null);
  useEffect(() => {
    if (!openAbout) return;
    const onDoc = (e) => { if (aboutRef.current && !aboutRef.current.contains(e.target)) setOpenAbout(false); };
    const onKey = (e) => { if (e.key === 'Escape') setOpenAbout(false); };
  ...
  return (
    <nav style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8" style={{
        ...
        <a href="#top" onClick={(e) => onNavClick(e, 'top')}
          ...
          After <span style={{ fontStyle: 'italic' }}>Empire</span>
        </a>
        <div ref={aboutRef} style={{ position: 'relative' }}>
          <button onClick={() => setOpenAbout(o => !o)} aria-expanded={openAbout}
            style={{
              ...navItem,
              borderColor: openAbout ? 'rgba(var(--text-rgb),0.18)' : 'transparent',
              color: openAbout ? 'var(--text)' : 'rgba(var(--text-rgb),0.78)',
            }}>
            About <span style={{ marginLeft: 6, fontSize: 8 }}>▼</span>
          </button>
          {openAbout && (
            <div style={{
              ...
              <a href="#about-this-project" onClick={(e) => onNavClick(e, 'about-this-project')}
                style={{ ...navItem, display: 'block', textAlign: 'left' }}>
                About this project
              </a>
              <a href="#authors-note" onClick={(e) => onNavClick(e, 'authors-note')}
                style={{ ...navItem, display: 'block', textAlign: 'left' }}>
                Author&apos;s note
              </a>
            </div>
        ...
        <a href="#part-i"  onClick={(e) => onNavClick(e, 'part-i')}  style={navItem}>Part I</a>
        <a href="#part-ii" onClick={(e) => onNavClick(e, 'part-ii')} style={navItem}>Part II</a>
        <a href="#part-iii"onClick={(e) => onNavClick(e, 'part-iii')}style={navItem}>Part III</a>
        <a href="#part-iv" onClick={(e) => onNavClick(e, 'part-iv')} style={navItem}>Part IV</a>
        <a href="#references" onClick={(e) => onNavClick(e, 'references')} style={navItem}>References</a>
        <button
          onClick={() => setTheme(t => t === 'dark' ? 'light' : 'dark')}
          aria-label={`Switch to ${theme === 'dark' ? 'light' : 'dark'} theme`}
          style={{
            ...navItem,
            borderColor: 'rgba(var(--text-rgb), 0.18)',
            marginLeft: 4,
          }}>
          {theme === 'dark' ? '☼' : '☾'}
        </button>
...
export default function AsiaViolenceTimeline() {
  ...
  const filteredEvents = useMemo(() => {
    return EVENTS.filter(e =>
      ...
      (activeCategory === "Both" ||
       ...
       (activeCategory === "One-sided Violence" && e.category === "One-sided Violence")) &&
  ...
  const ongoing = filteredEvents.filter(e => e.ongoing === true).length;
  ...
  return (
    <div className="min-h-screen w-full" data-theme={theme} style={{
      ...
      <div id="top" className="max-w-7xl mx-auto px-4 sm:px-8 py-8 sm:py-12 relative">
        {/* HEADER */}
        <header className="mb-8 sm:mb-12">
          ...
          <p className="serif italic mb-7 max-w-5xl" style={{ color: 'rgba(var(--text-rgb),0.85)', fontSize: 'clamp(17px, 2.4vw, 22px)', lineHeight: 1.3 }}>
            Asia, Violence, and the Histories Behind Asian Heritage Month (1945&#x2013;2026)
          </p>
          <div className="max-w-5xl">
            <IntroSection eyebrow="ABOUT THIS PROJECT" id="about-this-project">
              <p>
                This is an independent personal research and memory project. It is not affiliated with, endorsed by, reviewed by, or representative of any employer, humanitarian organization, Red Cross / Red Crescent component, government, or academic institution. The author writes only in a personal capacity.
              </p>
              <p>
                The project uses only publicly available sources. It does not contain, rely on, or imply access to non-public humanitarian, operational, security, diplomatic, or organizational information. It is not an operational humanitarian analysis, advocacy product, legal assessment, early-warning product, or programmatic recommendation.
              </p>
              <p>
                Terminology for ongoing conflicts is descriptive and source-attributed wherever possible. Legal characterizations such as genocide, crimes against humanity, ethnic cleansing, occupation, or war crimes are used only where attributed to courts, UN bodies, commissions of inquiry, governments, or named scholarly sources.
              </p>
            </IntroSection>

            <IntroSection eyebrow="AUTHOR'S NOTE" id="authors-note">
              <p>
                I built this catalogue and these essays over many evenings, weekends, and stolen mornings, with whatever quiet I could carve out around a full-time job and the rest of a life. It is the work of one person reading widely and carefully &#x2014; not the product of an institution, a team of researchers, or a funded programme. Mistakes that remain are mine; the conviction that the underlying history is worth assembling, all the same, is also mine.
              </p>
              <p>
                I am Chinese-Canadian. I grew up around the silences that follow people out of the twentieth century &#x2014; in my own family, in friends&apos; families, in the languages I half-inherited and the ones I didn&apos;t. The May commemoration calendars I encountered as a child in Canada tended to begin with the arrival; this project tries to make a small space for what came before, around, and after the arrival, without flattening any of it. The point is not to reduce Asia to its violences. It is to refuse the tidiness of stories that begin only at the border.
              </p>
            </IntroSection>
        ...
        {/* PART I                                                          */}
        {/* ============================================================ */}
        <section className="mt-12 sm:mt-16" id="part-i">
          ...
          <div className="space-y-4 sans text-[14px] sm:text-[15px] leading-relaxed max-w-5xl mb-7" style={{ color: 'rgba(var(--text-rgb),0.85)' }}>
            <p>
              Part I presents the catalogue itself. The catalogue currently includes armed conflicts and events of one-sided violence across Asia from 1945 through 2026, informed by UCDP, PRIO, ACLED, UN documentation, human-rights investigations, and historical scholarship; several entries use a declared custom category beyond institutional conflict-dataset coding. This is a versioned dataset, last updated 12 May 2026, and is treated as an interpretive catalogue rather than a definitive record.
            </p>
            <p>
          ...
          <div className="max-w-5xl mb-8">
            <IntroSection eyebrow="SCOPE">
              <p>
                This project gathers interstate wars, occupations, insurgencies, and events of one-sided violence (politicide, ethnic cleansing, state repression, detention systems, policy-induced famine, and large-scale violence directed primarily against civilian populations) across Asia from 1945 to 2026. Solid bars represent armed conflict. Patterned bars represent one-sided violence.<Cite ids={[1, 2, 3, 60, 61, 62]}/>
              </p>
            </IntroSection>
            ...
            <IntroSection eyebrow={`DATA AS OF ${DATA_AS_OF.toUpperCase()}`}>
              <p>
                Figures for ongoing events &#x2014; marked with a trailing <strong>+</strong> on the death and displacement counts &#x2014; are running totals through {DATA_AS_OF} and will change. The list of events currently treated as ongoing for catalogue purposes includes the Israel&#x2013;Hamas Gaza war, the Israel&#x2013;Hezbollah/Lebanon hostilities (2026), the Iran&#x2013;Israel/US hostilities (2026), the Myanmar post-coup civil war, the Afghanistan&#x2013;Pakistan border clashes, the West Papua conflict, the Xinjiang campaign, the North Korean <em>kwalliso</em> system, the Falun Gong persecution, and the Laogai forced-labour system.
              </p>
            </IntroSection>
          ...
          {/* VIEW TOGGLE — segmented pill so the two views look like
              parallel options rather than a primary + alternate. */}
          <div className="mb-7" style={{
            ...
            {[['convergence', 'CONVERGENCE', 'Map · symbols · year grid'],
              ['database', 'DATABASE', 'Horizontal bars · expandable rows']].map(([k, lbl, sub]) => (
              <button key={k} onClick={() => setViewMode(k)}
                ...
                style={{
                  ...
                  color: viewMode === k ? 'var(--bg)' : 'rgba(var(--text-rgb),0.78)',
                  border: 'none',
                  cursor: 'pointer',
                  padding: '7px 16px',
                  borderRadius: 999,
          ...
          {viewMode === 'convergence' ? (
            <aside className="max-w-5xl mb-10 p-5 sm:p-6 rounded"
              style={{
              ...
              <dl className="m-0">
                {[
                  { term: 'Shape encodes category.', def: 'A filled circle marks an armed conflict (interstate war, civil war, sustained insurgency, conventional clash). A filled diamond marks a campaign of one-sided violence (politicide, ethnic cleansing, genocide, policy-induced famine, or systematic detention).' },
            ...
            <aside className="mb-10 p-5 sm:p-6 rounded-2xl"
              style={{
                background: 'rgba(var(--text-rgb),0.04)',
                borderLeft: '3px solid var(--accent)',
              }}>
              ...
              <p className="sans text-[13.5px] sm:text-[14.5px] leading-relaxed mb-5" style={{ color: 'rgba(var(--text-rgb),0.82)' }}>
                The timeline below renders each catalogue event as a horizontal bar positioned by its year span. Bar colour reflects the event&apos;s region. Click any bar to expand its full description, including casualty figures, displaced figures, and source citations. Hover the bar for the year range and the countries involved. Use the year-range slider, the category pills, the group-by toggle, and the country filter to narrow the catalogue.
              </p>
              {/* WHAT THIS TIMELINE INCLUDES — taxonomy folded into the
                  Reader's Guide so the encoding key lives next to the
                  prose explanation rather than as a separate strip. */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 pt-4"
                style={{ borderTop: '1px solid rgba(var(--text-rgb),0.10)' }}>
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <div style={{ width: 40, height: 8, backgroundColor: 'var(--accent)', borderRadius: 2 }} />
                    <div className="mono text-[10px] tracking-[0.15em]" style={{ color: 'var(--text)' }}>
                      SOLID &middot; ARMED CONFLICT
                    </div>
                  </div>
                  <ul className="sans text-[12.5px] space-y-0.5 pl-[52px]"
                    style={{ color: 'rgba(var(--text-rgb),0.78)' }}>
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="mono text-[10px] tracking-[0.15em]" style={{ color: 'var(--text)' }}>
                      PATTERNED &middot; ONE-SIDED VIOLENCE
                    </div>
                  </div>
                  <ul className="sans text-[12.5px] space-y-0.5 pl-[52px]"
                    style={{ color: 'rgba(var(--text-rgb),0.78)' }}>
        ...
        {/* DATABASE CONTROL PANEL — single rounded container with two
            columns. Left: three stats, year range, category, group-by.
            Right: country / region filter. Mirrors the Convergence
            dashboard so the two views feel like siblings rather than
            unrelated screens. */}
        <div className="mb-8 rounded-2xl"
          ...
          <div className="grid gap-6 md:gap-8"
            ...
            {/* LEFT column: three numbers, year slider, category, group-by */}
            <div className="space-y-6">
              <div className="grid grid-cols-3 gap-4 sm:gap-6">
                <div>
                  <div className="serif" style={{
                    color: 'var(--accent)', fontSize: 32, lineHeight: 1, fontWeight: 500,
                    fontVariantNumeric: 'tabular-nums',
                  }}>{total}</div>
                  <div className="mono text-[10px] mt-2 tracking-[0.18em]" style={{ color: 'rgba(var(--text-rgb),0.55)' }}>
                    Events in range
                  </div>
                </div>
                <div>
                  <div className="serif" style={{
                    color: 'var(--text)', fontSize: 24, lineHeight: 1, fontWeight: 500,
                    fontVariantNumeric: 'tabular-nums',
                  }}>{armed}</div>
                  <div className="mono text-[10px] mt-2 tracking-[0.18em]" style={{ color: 'rgba(var(--text-rgb),0.55)' }}>
                    Armed conflict
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Both", "Armed Conflict", "One-sided Violence"].map(catLabel => {
                      const on = activeCategory === catLabel;
                      return (
            ...
            {/* RIGHT column: country / region filter */}
            <div>
              <CountryFilter
                ...
                <section key={country}>
                  ...
                  <div>
                    {data.events.map(e => {
                      ...
                      return <EventRow key={key} ev={e} expanded={expanded === key} onToggle={() => setExpanded(expanded === key ? null : key)} yearStart={yearStart} yearEnd={yearEnd} dense />;
                    })}
                  </div>
                </section>
              );
        ...
        {/* PART II                                                         */}
        {/* ============================================================ */}
        <section className="mt-20 sm:mt-24" id="part-ii">
          ...
          <div className="space-y-4 sans text-[14px] sm:text-[15px] leading-relaxed max-w-5xl" style={{ color: 'rgba(var(--text-rgb),0.85)' }}>
            <p>
              One of the clearest patterns visible across postwar Asia is not simply the recurrence of violence, but its uneven distribution. Across the eighty years recorded in this timeline, large parts of the continent moved through repeated cycles of war, partition, insurgency, occupation, dictatorship, and political repression. Under the project's current catalogue rules, a small number of countries appear with no qualifying post-1945 catalogue entry, but this category should not be read as "peaceful societies" or as proof of an absence of state violence. It means only that no event meeting this project's inclusion threshold has been entered after the stated exclusions and caveats are applied.
            </p>
            <p>
              <strong style={{ color: 'var(--text)' }}>Brunei</strong> is excluded from this category because the 1962 Brunei Revolt meets the project's armed-conflict threshold and is included as a catalogue entry. <strong style={{ color: 'var(--text)' }}>Kazakhstan</strong> is treated as an edge case because the January 2022 unrest and crackdown involved mass casualties and credible allegations of excessive state force, even though classification under UCDP-style one-sided violence requires careful treatment. <strong style={{ color: 'var(--text)' }}>Singapore</strong> is treated only as a post-independence case, because the 1964 riots and 1965 MacDonald House bombing belong to the island's immediate pre-independence history.
            </p>
            <p>
              The list is also shorter than the popular narrative usually suggests. Bhutan is sometimes named informally as a model of peace, particularly in tourism literature and in some summary comparative-politics accounts. The historical record does not sustain the claim. Between 1990 and 1993, the Bhutanese state's <em>One Nation, One People</em> policy and the 1985 Citizenship Act produced a campaign that forcibly displaced approximately 108,000 ethnic Nepali Lhotshampa, documented by Human Rights Watch as ethnic cleansing.<Cite ids={[59]}/> The Maldives appears in the catalogue for the 1988 coup attempt. Uzbekistan appears for the 2005 Andijan massacre and the 2010 Kyrgyz-Uzbek violence.
            </p>
          </div>

          <ExceptionsTable />

          <div className="space-y-4 sans text-[14px] sm:text-[15px] leading-relaxed max-w-5xl mt-2" style={{ color: 'rgba(var(--text-rgb),0.85)' }}>
            <p>
              The significance of these cases lies less in any inherent cultural disposition toward peace than in the structural conditions that made relative stability possible. The absence of major war did not necessarily imply liberal democracy, political openness, or equality. Singapore combined stability with highly securitized governance and extensive restrictions on opposition politics.<Cite ids={[48]}/> Mongolia remained deeply constrained by Soviet influence throughout much of the Cold War.<Cite ids={[49]}/> Postwar Japan developed under extensive American military protection despite constitutional restrictions on warfare.<Cite ids={[50]}/> The central question is therefore not why some Asian societies were naturally peaceful, but how relative stability became historically sustainable under particular geopolitical conditions.
            </p>
          </div>

          <div className="mt-10 space-y-4 sans text-[14px] sm:text-[15px] leading-relaxed max-w-5xl" style={{ color: 'rgba(var(--text-rgb),0.85)' }}>
            <p>
              The remaining cases divide into three archetypes rather than a checklist of overlapping conditions. Each country fits exactly one archetype. The typology is more analytically useful than a count of which structural conditions any given country exhibits, partly because the cases are too few for cumulative conditions to discriminate among them, and partly because the underlying mechanisms differ in kind, not merely in degree. Click any of the three cards below to read the full mechanism.
            </p>
          </div>

          <ArchetypesDiagram />

          {/* DEBATE + SYNTHESIS — integrated side-by-side block. The DEBATE
              side is the alternative framing (Kivimäki & Tønnesson's
              "developmental peace") and the SYNTHESIS side is the
              project's own qualified position. Rendered as two columns
              so the reader sees them as parallel claims rather than as
              successive subsections to be read sequentially. */}
          <div className="mt-12 grid gap-5 md:grid-cols-2 max-w-5xl">
            <div className="p-5 sm:p-6 rounded-2xl" style={{
              border: '1px solid rgba(var(--text-rgb),0.14)',
              background: 'rgba(var(--text-rgb),0.025)',
            }}>
              <div className="mono text-[10px] tracking-[0.25em] mb-2"
                style={{ color: 'var(--accent)' }}>DEBATE</div>
              <h3 className="serif font-medium mb-3"
                style={{ color: 'var(--text)', fontSize: 'clamp(20px, 2.6vw, 24px)', lineHeight: 1.2 }}>
                Frameworks in dialogue
              </h3>
              <p className="sans text-[13.5px] sm:text-[14.5px] leading-relaxed"
                style={{ color: 'rgba(var(--text-rgb),0.85)' }}>
                The framework presented here &#x2014; peace as a function of external security architecture, strategic insulation, and the geopolitical calculations of larger actors &#x2014; is not the only academic framework available. Timo Kivim&#xE4;ki and Stein T&#xF8;nnesson have argued, in extended work, for what they call a <em>developmental peace</em> in East Asia: a regional shift in elite priorities toward economic development over warfare, supported by ASEAN's principle of non-intervention, by the prioritization of welfare over warfare in the major Asian capitalist economies, and by what they have called an <em>ASEAN/Chinese Way</em> of conducting interstate relations.
              </p>
              <p className="sans text-[13.5px] sm:text-[14.5px] leading-relaxed mt-3"
                style={{ color: 'rgba(var(--text-rgb),0.78)' }}>
                The two frameworks are not mutually exclusive. Developmental priorities flourish under external security guarantees, and security guarantees are sustained in part by the resulting economic interdependence. They emphasize different causal mechanisms.
              </p>
            </div>
            <div className="p-5 sm:p-6 rounded-2xl" style={{
              borderLeft: '3px solid var(--accent)',
              ...
              <div className="mono text-[10px] tracking-[0.25em] mb-2"
                style={{ color: 'var(--accent)' }}>SYNTHESIS</div>
              <h3 className="serif font-medium mb-3"
                style={{ color: 'var(--text)', fontSize: 'clamp(20px, 2.6vw, 24px)', lineHeight: 1.2 }}>
                What this project weights, and why
              </h3>
              <p className="sans text-[13.5px] sm:text-[14.5px] leading-relaxed"
                style={{ color: 'rgba(var(--text-rgb),0.88)' }}>
                The version offered here weights the structural-geopolitical mechanism more heavily &#x2014; while acknowledging that the developmental-peace argument captures something real about how peace was reproduced, year over year, once the structural conditions were in place. The pattern across the cases is suggestive rather than determinative; peace in Asia since 1945 has rarely been explainable by domestic choice alone.
              </p>
              <p className="sans text-[13.5px] sm:text-[14.5px] leading-relaxed mt-3"
                style={{ color: 'rgba(var(--text-rgb),0.78)' }}>
                Where these conditions held, large-scale armed conflict appears to have been less likely under this project's inclusion rules. Where they did not, the probability of conflict was shaped by many additional factors: regime type, colonial borders, external sponsorship, domestic state formation, economic development, social movements, and regional security institutions.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* PART III                                                        */}
        {/* ============================================================ */}
        <section className="mt-20 sm:mt-24" id="part-iii">
          ...
          {/* Three historical mechanisms — left column shows the small
              card identifying the mechanism's period and headline; the
              right column carries the full body text. Each row reads
              as a self-contained unit so the reader can scan or read
              in depth, mechanism by mechanism. */}
          <MechanismsTwoColumn mechanisms={MECHANISMS} />
        ...
        {/* PART IV                                                         */}
        {/* ============================================================ */}
        <section className="mt-20 sm:mt-24" id="part-iv">
          ...
          <div className="space-y-4 sans text-[14px] sm:text-[15px] leading-relaxed max-w-5xl" style={{ color: 'rgba(var(--text-rgb),0.85)' }}>
            ...
            <p>
              For the broader categories that this project also includes &#x2014; politicide, mass detention, systematic state repression, policy-induced famine &#x2014; the analytical literature draws on Barbara Harff's Genocide/Politicide dataset,<Cite ids={[60]}/> the Political Terror Scale,<Cite ids={[61]}/> and the Political Instability Task Force <em>State Failure</em> dataset,<Cite ids={[62]}/> supplemented by individual UN Commission of Inquiry reports and by academic monographs cited per event.<Cite ids={[8]}/> Lacina and Gleditsch's 2005 article in the <em>European Journal of Population</em> sets out the methodological distinctions between combatant deaths, battle deaths, and war deaths that this project follows.<Cite ids={[47]}/>
            </p>
          </div>

          <SubsectionHeading title="Audit trail" />
          <div className="space-y-4 sans text-[14px] sm:text-[15px] leading-relaxed max-w-5xl" style={{ color: 'rgba(var(--text-rgb),0.85)' }}>
            <p>
              To support reviewer audit, the catalogue is downloadable as a coded CSV with one row per event. Fields include event identifier, country attribution, year span, ongoing flag, category (armed conflict or one-sided violence, with a flag marking the latter as the project's declared custom extension), inclusion in cumulative death and displacement totals, mid-range estimates parsed from the source string, derived fatality type, derived displacement type, citation indices, legal terms used in the event description, attributed sources for those legal characterizations, uncertainty notes, and the dataset version date.
            </p>
            <p>
              Derived fields (<code>fatality_type</code>, <code>displacement_type</code>, <code>legal_terms_used</code>, <code>legal_term_source</code>, <code>notes_on_uncertainty</code>) are produced heuristically from each event's own text and category. They are intended to support reviewer audit, not to stand alone as authoritative coding judgments.
            </p>
            <button
              onClick={() => downloadMethodologyCsv()}
              className="mono text-[11px] tracking-[0.18em] px-4 py-2 rounded-full mt-2"
              style={{
        ...
        {/* REFERENCES                                                      */}
        {/* ============================================================ */}
        <section className="mt-20 sm:mt-24" id="references">
          <h2 className="serif font-medium mb-6" style={{ color: 'var(--text)', fontSize: 'clamp(26px, 4vw, 32px)', lineHeight: 1.1 }}>
            References
          </h2>
          {(() => {
                ...
                {CITATIONS.map(c => {
                  ...
                  return (
                    <React.Fragment key={c.n}>
                      {section && (
                        <li className="mono"
                          style={{
                            ...
                            marginTop: 16, marginBottom: 6, padding: '0 6px',
                          }}>
                      ...
                      <li id={'ref-' + c.n}
                        style={{
                          display: 'flex', gap: 8, padding: '2px 6px',
                          scrollMarginTop: '4rem',
                        }}>
                        <span className="mono" style={{
                          color: 'rgba(var(--text-rgb),0.45)',
                          minWidth: 24, fontSize: 10, flexShrink: 0,
                        }}>{c.n}.</span>
                        <span style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <a href={c.url} target="_blank" rel="noopener noreferrer"
                            ...
                            style={{
                              ...
                              textDecorationColor: 'rgba(var(--text-rgb),0.18)',
